...
function createCartService({ db, id, now, money, addMoney, productResponse, orderTypeForCartItem, shippingInfoForProduct }) {
  function getOrCreateCart(buyerId) {
  ...
  function cartResponse(cart, locale = 'mn', currency = 'MNT') {
    let subtotal = null;
