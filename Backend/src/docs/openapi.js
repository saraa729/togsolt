...
const ROUTE_TABLE = [
  ...
  ['post', '/checkout', 'Checkout the cart and capture escrow payment', 'Orders', true],
  ...
  ['get', '/conversations/stream', 'Server-sent events stream for realtime messages', 'Custom & Trust', true],
